/* Synthetic PAYOR_A-H, UI Demo, and functional template hierarchy scenarios. */
SET DEFINE OFF
...
INSERT ALL
    ...
    INTO payors VALUES (
        '10000000-0000-0000-0000-00000000B101',
        '11000000-0000-0000-0000-000000000001',
        'Synthetic Hierarchy Payor 01', 'SYN-HIER-01', DATE '2026-01-01',
        '90000000-0000-0000-0000-000000000001', NULL, NULL
    )
    INTO payors VALUES (
        '10000000-0000-0000-0000-00000000B102',
        '11000000-0000-0000-0000-000000000001',
        'Synthetic Hierarchy Payor 02', 'SYN-HIER-02', DATE '2026-01-01',
        '90000000-0000-0000-0000-000000000001', NULL, NULL
    )
    INTO payors VALUES (
        '10000000-0000-0000-0000-00000000B103',
        '11000000-0000-0000-0000-000000000001',
        'Synthetic Hierarchy Payor 03', 'SYN-HIER-03', DATE '2026-01-01',
        '90000000-0000-0000-0000-000000000001', NULL, NULL
    )
    INTO payors VALUES (
        '10000000-0000-0000-0000-00000000B104',
        '11000000-0000-0000-0000-000000000001',
        'Synthetic Hierarchy Payor 04', 'SYN-HIER-04', DATE '2026-01-01',
        '90000000-0000-0000-0000-000000000001', NULL, NULL
    )
    INTO payors VALUES (
        '10000000-0000-0000-0000-00000000B105',
        '11000000-0000-0000-0000-000000000001',
        'Synthetic Hierarchy Payor 05', 'SYN-HIER-05', DATE '2026-01-01',
        '90000000-0000-0000-0000-000000000001', NULL, NULL
    )
    INTO payors VALUES (
        '10000000-0000-0000-0000-00000000B106',
        '11000000-0000-0000-0000-000000000001',
        'Synthetic Hierarchy Payor 06', 'SYN-HIER-06', DATE '2026-01-01',
        '90000000-0000-0000-0000-000000000001', NULL, NULL
    )
    INTO payors VALUES (
        '10000000-0000-0000-0000-00000000B107',
        '11000000-0000-0000-0000-000000000001',
        'Synthetic Hierarchy Payor 07', 'SYN-HIER-07', DATE '2026-01-01',
        '90000000-0000-0000-0000-000000000001', NULL, NULL
    )
    INTO payors VALUES (
        '10000000-0000-0000-0000-00000000B108',
        '11000000-0000-0000-0000-000000000001',
        'Synthetic Hierarchy Payor 08', 'SYN-HIER-08', DATE '2026-01-01',
        '90000000-0000-0000-0000-000000000001', NULL, NULL
    )
    INTO payors VALUES (
        '10000000-0000-0000-0000-00000000B109',
        '11000000-0000-0000-0000-000000000001',
        'Synthetic Hierarchy Payor 09', 'SYN-HIER-09', DATE '2026-01-01',
        '90000000-0000-0000-0000-000000000001', NULL, NULL
    )
SELECT 1 FROM dual;
...
INSERT ALL
    ...
    INTO pfc_config_payor_context VALUES (
        '10000000-0000-0000-0000-00000000B101', 'HOME_HEALTH',
        DATE '2026-01-01', '90000000-0000-0000-0000-000000000001', NULL, NULL
    )
    INTO pfc_config_payor_context VALUES (
        '10000000-0000-0000-0000-00000000B102', 'HOME_HEALTH',
        DATE '2026-01-01', '90000000-0000-0000-0000-000000000001', NULL, NULL
    )
    INTO pfc_config_payor_context VALUES (
        '10000000-0000-0000-0000-00000000B103', 'HOME_HEALTH',
        DATE '2026-01-01', '90000000-0000-0000-0000-000000000001', NULL, NULL
    )
    INTO pfc_config_payor_context VALUES (
        '10000000-0000-0000-0000-00000000B104', 'HOME_HEALTH',
        DATE '2026-01-01', '90000000-0000-0000-0000-000000000001', NULL, NULL
    )
    INTO pfc_config_payor_context VALUES (
        '10000000-0000-0000-0000-00000000B105', 'HOME_HEALTH',
        DATE '2026-01-01', '90000000-0000-0000-0000-000000000001', NULL, NULL
    )
    INTO pfc_config_payor_context VALUES (
        '10000000-0000-0000-0000-00000000B106', 'HOME_HEALTH',
        DATE '2026-01-01', '90000000-0000-0000-0000-000000000001', NULL, NULL
    )
    INTO pfc_config_payor_context VALUES (
        '10000000-0000-0000-0000-00000000B107', 'HOSPICE',
        DATE '2026-01-01', '90000000-0000-0000-0000-000000000001', NULL, NULL
    )
    INTO pfc_config_payor_context VALUES (
        '10000000-0000-0000-0000-00000000B108', 'HOSPICE',
        DATE '2026-01-01', '90000000-0000-0000-0000-000000000001', NULL, NULL
    )
    INTO pfc_config_payor_context VALUES (
        '10000000-0000-0000-0000-00000000B109', 'HOSPICE',
        DATE '2026-01-01', '90000000-0000-0000-0000-000000000001', NULL, NULL
    )
SELECT 1 FROM dual;
...
INSERT ALL
    ...
    /*
     * Dedicated hierarchy mix. Every plan belongs to exactly one payor.
     * Form and user templates intentionally include shared, unique, and null
     * assignments without changing the existing A-H behavior fixtures.
     */
    INTO pfc VALUES (
        '20000000-0000-0000-0000-00000000B101',
        '10000000-0000-0000-0000-00000000B101',
        'I', '837I_5010', 'E', NULL,
        '60000000-0000-0000-0000-00000000B101', NULL, NULL,
        DATE '2025-01-01', NULL, DATE '2025-01-01', DATE '2099-12-31',
        DATE '2026-01-01', '90000000-0000-0000-0000-000000000001', NULL, NULL
    )
    INTO pfc VALUES (
        '20000000-0000-0000-0000-00000000B102',
        '10000000-0000-0000-0000-00000000B102',
        'I', '837I_5010', 'E',
        '40000000-0000-0000-0000-00000000B100',
        '60000000-0000-0000-0000-00000000B102', NULL, NULL,
        DATE '2025-01-01', NULL, DATE '2025-01-01', DATE '2099-12-31',
        DATE '2026-01-01', '90000000-0000-0000-0000-000000000001', NULL, NULL
    )
    INTO pfc VALUES (
        '20000000-0000-0000-0000-00000000B103',
        '10000000-0000-0000-0000-00000000B103',
        'I', '837I_5010', 'E',
        '40000000-0000-0000-0000-00000000B100',
        '60000000-0000-0000-0000-00000000B103', NULL, NULL,
        DATE '2025-01-01', NULL, DATE '2025-01-01', DATE '2099-12-31',
        DATE '2026-01-01', '90000000-0000-0000-0000-000000000001', NULL, NULL
    )
    INTO pfc VALUES (
        '20000000-0000-0000-0000-00000000B104',
        '10000000-0000-0000-0000-00000000B104',
        'I', '837I_5010', 'E', NULL,
        '60000000-0000-0000-0000-00000000B104', NULL,
        '50000000-0000-0000-0000-00000000B100',
        DATE '2025-01-01', NULL, DATE '2025-01-01', DATE '2099-12-31',
        DATE '2026-01-01', '90000000-0000-0000-0000-000000000001', NULL, NULL
    )
    INTO pfc VALUES (
        '20000000-0000-0000-0000-00000000B105',
        '10000000-0000-0000-0000-00000000B105',
        'I', '837I_5010', 'E', NULL,
        '60000000-0000-0000-0000-00000000B105', NULL,
        '50000000-0000-0000-0000-00000000B100',
        DATE '2025-01-01', NULL, DATE '2025-01-01', DATE '2099-12-31',
        DATE '2026-01-01', '90000000-0000-0000-0000-000000000001', NULL, NULL
    )
    INTO pfc VALUES (
        '20000000-0000-0000-0000-00000000B106',
        '10000000-0000-0000-0000-00000000B106',
        'I', '837I_5010', 'E',
        '40000000-0000-0000-0000-00000000B100',
        '60000000-0000-0000-0000-00000000B106', NULL,
        '50000000-0000-0000-0000-00000000B100',
        DATE '2025-01-01', NULL, DATE '2025-01-01', DATE '2099-12-31',
        DATE '2026-01-01', '90000000-0000-0000-0000-000000000001', NULL, NULL
    )
    INTO pfc VALUES (
        '20000000-0000-0000-0000-00000000B107',
        '10000000-0000-0000-0000-00000000B107',
        'I', '837I_5010', 'E',
        '40000000-0000-0000-0000-00000000B200',
        '60000000-0000-0000-0000-00000000B107', NULL, NULL,
        DATE '2025-01-01', NULL, DATE '2025-01-01', DATE '2099-12-31',
        DATE '2026-01-01', '90000000-0000-0000-0000-000000000001', NULL, NULL
    )
    INTO pfc VALUES (
        '20000000-0000-0000-0000-00000000B108',
        '10000000-0000-0000-0000-00000000B108',
        'I', '837I_5010', 'E',
        '40000000-0000-0000-0000-00000000B200',
        '60000000-0000-0000-0000-00000000B108', NULL,
        '50000000-0000-0000-0000-00000000B200',
        DATE '2025-01-01', NULL, DATE '2025-01-01', DATE '2099-12-31',
        DATE '2026-01-01', '90000000-0000-0000-0000-000000000001', NULL, NULL
    )
    INTO pfc VALUES (
        '20000000-0000-0000-0000-00000000B109',
        '10000000-0000-0000-0000-00000000B109',
        'I', '837I_5010', 'E',
        '40000000-0000-0000-0000-00000000B200',
        '60000000-0000-0000-0000-00000000B109', NULL,
